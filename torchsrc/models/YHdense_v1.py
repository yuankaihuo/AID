...
def densenetyh(**kwargs):
    model = DenseNet(
        num_init_features=128,  #from 64
        growth_rate=32,
        block_config=(12, 0, 0, 0 ),
        **kwargs)
    return model
...
class DenseNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 bn_size=4,
                 drop_rate=0,
                 num_classes=3): #change it from 1000 yuankai
        ...
        # self.avgpool = nn.MaxPool3d(kernel_size=(last_duration, last_size0, last_size1))
